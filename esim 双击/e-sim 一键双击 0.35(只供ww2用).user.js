// ==UserScript==
// @name         e-sim 一键双击(ww2)
// @namespace    EsimAWTww2
// @version      0.35
// @description  模拟人工双击，最安全的e-sim双击插件
// @author       Exsper
// @match        http://ww2.e-sim.org/*
// @match        https://ww2.e-sim.org/*
// @grant        none
// ==/UserScript==
...
function addIcon()
{
    ...
    $("<b>", {text:"e-sim 一键双击(ww2)" + GM_info.script.version}).appendTo(AWTContentDrop).after("<br>"); // 版本号
...
function autoWork()
{
    ...
    else //需要工作
    {
        if (getValue('isAutoWorked') == "true") //已点击过工作按钮
        {
            ...
            {
                //已经自动工作过却未工作成功
                //换日工作提示：Day change is taking place, please wait a few seconds.
