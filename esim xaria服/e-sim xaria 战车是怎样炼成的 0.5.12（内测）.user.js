...
//这里是全局变量，插件某些设置可以在下面全局变量里修改，变量涉及时间的如果没有特殊说明均为毫秒单位
...
function autoFight()
{
    ...
    if ((getUrlPage() == "battle") && (s_AFC_TargetBattleID == parseInt($('a[href^="battleStatistics.html?id="]').attr('href').replace('battleStatistics.html?id=', '')))) //检查是否是重要战场
    {
        //判断是否压秒
