...
function addIcon()
{
    ...
    //搜寻网址
    addCheckBoxSettingFrame(td, 'AutoSearchBattleCheckbox', '自动寻找战场', "ESX-AutoSearchBattle", s_AF_AutoSearchBattle);
    ...
    function AFSendFightRequest(side, value)
    {
        ...
        var ajax = $.ajax({
            ...
            error: function(XMLHttpRequest, textStatus, errorThrown) {
                warningCount++;
                ShowMessage("错误："+XMLHttpRequest.status+"("+warningCount+")");
                if (warningCount>s_AF_MaxWarningCounts)
                {
                    refreshingWhenCrashed();
                }
