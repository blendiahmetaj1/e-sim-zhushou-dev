...
function addIcon()
{
    ...
    {
        var $textbox = $("<input>", {type:"text",id:"ESX-"+localStorageName, style:"vertical-align:5px;width:"+width+"px;height:25px;"}).appendTo($appendToElement);
        var localStorageSetting = getValue(localStorageName);
        if (localStorageSetting === null)
        {
            setValue(localStorageName, defaultValue);
    ...
    // 若干功能选择框和按钮
    var table = $("<table>", {id:"ESXConfig", style:"width:100%;line-height:35px"}).appendTo(ESXContentDrop);
