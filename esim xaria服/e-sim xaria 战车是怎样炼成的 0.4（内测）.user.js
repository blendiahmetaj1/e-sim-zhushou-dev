...
var s_AF_NextRefreshExtendWaitMax = 240; //输出后下次刷新延时下限（秒）
...
function addIcon()
{
    ...
    //输出方选择框
    addSelectSettingFrame(td, "可以打两边时选择输出方：", [0,1,2,-1], ["防守方","进攻方","第一名伤害低的那一方","随机"], "ESX-FightDefaultSide", s_FightDefaultSide);
